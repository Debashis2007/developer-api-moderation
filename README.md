...
**Parent system design:** [06 — Multi-Layer Safety / Moderation](https://github.com/Debashis2007/developer-api-moderation/blob/main/06-safety-moderation-pipeline.md)  
**Also references:** [09 — API platform](https://github.com/Debashis2007/developer-api-moderation/blob/main/09-multi-model-routing-api-platform.md)
...
- Bypass via tools → tool outputs also moderated ([07](https://github.com/Debashis2007/developer-api-moderation/blob/main/07-agent-runtime-containment.md)).
